...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Developer Preview Token
    |--------------------------------------------------------------------------
    |
    | Configure a token that must be supplied when accessing developer-only
    | preview routes in non-local environments. Set DEV_PREVIEW_TOKEN in
    | your environment and share the value only with trusted engineers.
    |
    */

    'dev_preview_token' => env('DEV_PREVIEW_TOKEN', ''),
